...
Usage:
    python visualize_sweep_dataframes.py drop_contig_tables drop_contig.json
    python generate_table.py my_experiment sweep_results_drop_random.json
"""
...
def main():
    ...
    # Excel
    try:
        xlsx_path = os.path.join(output_dir, f"sweep_{prefix}.xlsx")
...
# Example usage:
# python visualize_sweep_dataframes.py log_diffeo log_warp.json
