"""
Multi-trial version of unsupervised_hyperspectral_clustering.py.
...
Device handling:
  ...
  - When launched via run_corruption_sweep.py, CUDA_VISIBLE_DEVICES is set
...
EXAMPLES
nohup python -u unsupervised_hyperspectral_clustering_multitrial.py \
